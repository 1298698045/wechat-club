...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getStatus = () => {
      utils_request.get(utils_Interface.Interface.tourism.getMyStateCode, {
        id: id.value
      }).then((res) => {
    ...
    const getDetail = () => {
      utils_request.get(utils_Interface.Interface.tourism.detail, {
        id: id.value
      }).then((res) => {
        var _a;
    ...
    const getSignUpPeoples = () => {
      utils_request.get(utils_Interface.Interface.tourism.signPeoples, {
        id: id.value
      }).then((res) => {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-f6bfdfd4"]]);
